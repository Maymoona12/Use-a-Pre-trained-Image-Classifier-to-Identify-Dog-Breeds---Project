...
def get_input_args():
    ...
    # Define command-line arguments with default values and descriptions
    parser.add_argument('--dir', type=str, default='pet_images/',
                        help='Path to the folder containing pet images')
    parser.add_argument('--arch', type=str, default='vgg',
                        help='CNN model architecture to be used for image classification')
    parser.add_argument('--dogfile', type=str, default='dognames.txt',
                        help='File containing list of valid dog breeds')
